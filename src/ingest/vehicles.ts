...
// Honors the deployment's IMAGE_EMBEDDING_DIM (prod Jina 2048 / self-hosted CLIP
// 512). The fallback is 2048 to match the deployed profile.
const IMAGE_DIM = Number(process.env.IMAGE_EMBEDDING_DIM) || 2048;
